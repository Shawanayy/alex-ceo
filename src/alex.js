...
Shane replies to one of those conflict notifications picking a time (or says "leave it"), delegate that \
reply to the Admin Agent too so it can actually move (or not move) the event.
